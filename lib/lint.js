...
/**
 * Lint the file at a given path. If `filePath` has the `.md` extension, it will be treated as a Markdown file, and
 * this function will try to extract any YAML-ish front-matter from it and lint that.
 * @param {string} filePath Path to the file to lint.
 * @param {string|Buffer} [content] The content of the file to lint. If not provided, this function will read the file
 *   at `filePath`.
 * @param {object} [options] Options to pass to `lint`.
 * @returns {Promise<{issues: Array<YAMLException>, fixed: string}>} A promise for the return value of `lint()`.
 */
